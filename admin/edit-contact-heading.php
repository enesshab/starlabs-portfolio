...
<?php
    ...
    $contactHeading = $contactHeading->get_by_id(1);
    ...
    if(isset($_POST['submit_btn'])){
        ...
        if (empty($description)){
            ...
            $contactHeading->changeTitle($title, $description);
        ...
        <section class="main-hero edit-hero">
            <div class="edit-form">
                <div class="edit-heading">
                    <p>Edit contact headings</p>
                </div>
                
                <form method="post" action="edit-contact-heading.php" >
                    <div class="input-group">
                        <input type="text" name="title" class="input-field" placeholder="Title" value="<?php echo $contactHeading->getTitle(); ?>">
                    ...
                    <div class="input-group">
                        <textarea name="description" rows="10" placeholder="Description" class="input-message"><?php echo $contactHeading->getDescription(); ?></textarea>
                    ...
                    <div class="input-group input-buttons">
                        <a href="../index.php#contact" class="cancel-btn" class="cancel-btn">Cancel</a>
