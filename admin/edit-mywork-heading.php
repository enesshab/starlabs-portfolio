...
<?php
    ...
    $myworkHeading = new MyworkHeading();

    $myworkHeading = $myworkHeading->get_by_id(1);
    ...
    if(isset($_POST['submit_btn'])){
        ...
        if (empty($description)){
            ...
            $myworkHeading->changeTitle($title, $description);
        ...
        <section class="main-hero edit-hero">
            <div class="edit-form">
                <div class="edit-heading">
                    <p>Edit My Work headings</p>
                </div>
                
                <form method="post" action="edit-mywork-heading.php" >
                    <div class="input-group">
                        <input type="text" name="title" class="input-field" placeholder="Title" value="<?php echo $myworkHeading->getTitle(); ?>">
                    ...
                    <div class="input-group">
                        <textarea name="description" rows="10" placeholder="Description" class="input-message"><?php echo $myworkHeading->getDescription(); ?></textarea>
